...
class AppointmentType extends Model {
    ...
    protected $fillable = ['title','slug','meta_title','meta_description','og_image','schema_markup','robots','short_description','description','price','duration_minutes','break_minutes','images','is_active','sort_order','consent_template_id','mandatory_fields','getresponse_api_key','getresponse_list_id','company_id'];
